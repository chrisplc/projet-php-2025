...
class Reservation
{
    ...
    #[ORM\ManyToOne]
    #[ORM\JoinColumn(name: 'utilisateur_email', referencedColumnName: 'email', nullable: false)]
    ...
    public function getDateReservationFormatted(): string
    {
        return $this->dateReservation ? $this->dateReservation->format('d/m/Y H:i') : '';
    }
